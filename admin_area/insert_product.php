				...
				<div class="panel-body"><!-- panel-body start -->
					<form method="POST"  class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal start -->
						...
						<div class="form-group"><!-- form-group start -->
							...
							<div class="col-md-6"><!--col-md-6 start-->
								<input type="submit" value="Insert Product" name="submit" class="form-control btn btn-primary">
							</div><!-- col-md-6 end -->
						</div><!-- form-group end -->
...
if (isset($_POST['submit']))   
{
	...
	$insert_product="INSERT into products(p_cat_id,cat_id,date,product_tilte,product_img1,product_img2,product_img3, product_price,product_desc,product_keywords)values('$product_cat','$cat',NOW(),'$product_title','$product_img1','$product_img2','$product_img3','$product_price','$product_keywords','$product_desc')"; 
